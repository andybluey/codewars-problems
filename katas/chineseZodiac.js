...
function chineseZodiac(year){
  ...
  var baseYear = 1924;
  var givenYear = year - baseYear;
  var element = elements[(Math.floor(givenYear/2)%5)];
  var animal = animals[givenYear % 12];
  console.log((Math.floor(givenYear/2)%5));
  console.log(animal);
  return element + " " + animal;

}

console.log(chineseZodiac(1982));
